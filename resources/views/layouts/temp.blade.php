...
<head>
    ...
    <script src="https://cdn.jsdelivr.net/npm/summernote@0.8.18/dist/summernote-bs4.min.js"></script> <script src="{{ asset('assets/js/sb-admin-2.min.js')}}"></script>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ route('all.image')}}">Change slider</a>
                        <a class="collapse-item" href="{{ route('all.data')}}">Change Data</a>
                        <a class="collapse-item" href="{{ route('all.team')}}">Change Team</a>
